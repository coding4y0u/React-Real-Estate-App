...
var Filter = function (_Component) {
  ...
  function Filter() {
    ...
    _this.elevator = _this.elevator.bind(_this);
    return _this;
  }
  ...
  _createClass(Filter, [{
    ...
    key: 'elevator',
    value: function elevator() {
      if (this.props.globalState.populateFormsData.elevator != undefined) {
        var elevator = this.props.globalState.populateFormsData.elevator;


        console.log(elevator);
        return elevator.map(function (item) {
          return _react2.default.createElement(
            'input',
            { key: item, value: item },
            item
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'label',
            { className: 'homeFilters', htmlFor: 'city' },
            'City'
          ),
          _react2.default.createElement(
            'select',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', { type: 'text', name: 'min_price', className: 'min-price',
              onChange: this.props.change, value: this.props.globalState.min_price }),
          ...
          _react2.default.createElement(
            'div',
            { className: 'filters extras', onChange: this.props.change },
            _react2.default.createElement(
              'span',
              { className: 'title' },
              'Extras'
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('input', { name: 'elevator', value: this.props.globalState.elevator, type: 'checkbox',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('input', { name: 'finished_basement', value: 'finished basement', type: 'checkbox',
                onChange: this.props.change })
            ),
            _react2.default.createElement(
              'label',
...
var listingsData = [{
  ...
  extras: ['gym'],
  homeType: 'Apartment',
  image: 'https://homemydesign.com/wp-content/uploads/2012/09/unique-and-modern-apartments-design-by-lorcan-architects.jpg'
}, {
  address: '737 Gates Ave',
  city: 'Sprinfield',
  state: 'IN',
  rooms: 3,
  price: 58000,
  ...
  homeType: 'Ranch',
  image: 'http://www.koturltd.com/blog/wp-content/uploads/2013/11/jackie-kennedy-fifth-avenue-apartment-library-kotur.jpg'
}, {
  address: '94 Main St',
  city: 'Tampa Bay',
  state: 'FL',
  ...
  extras: ['elevator', 'gym'],
  homeType: 'House',
  image: 'http://greatergoodrealty.com/wp-content/uploads/2013/10/Apartment-Rentals-in-San-Diego.jpg'
}, {
  address: '35 John Street',
  city: 'Newerk',
  state: 'NJ',
  rooms: 0,
  price: 13000,
  ...
  extras: [''],
  homeType: 'Studio',
  image: 'https://i.ytimg.com/vi/xn8X7oZ3kKU/hqdefault.jpg'
}, {
  address: '67 Malaga Rd',
  city: 'Bedstuy',
  state: 'NY',
  rooms: 1,
  price: 94000,
